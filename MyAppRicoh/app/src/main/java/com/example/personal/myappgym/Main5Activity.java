...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Rv_Proyectores = (RecyclerView) findViewById(R.id.Rv_Proyectores);
        Rv_Proyectores.setLayoutManager(linearLayoutManager);
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Rv_Proyectores.setAdapter(adapterArticulos);
                    }
                });
            }
        };
