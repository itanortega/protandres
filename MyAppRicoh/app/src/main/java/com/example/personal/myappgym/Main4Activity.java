...
public class Main4Activity extends AppCompatActivity {
    ...
    String rutaApi = "produccion";

    RecyclerView Rv_Impresora_Produccion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Rv_Impresora_Produccion = (RecyclerView) findViewById(R.id.Rv_Impresora_Produccion);
        Rv_Impresora_Produccion.setLayoutManager(linearLayoutManager);
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Rv_Impresora_Produccion.setAdapter(adapterArticulos);
                    }
                });
            }
        };
